...
# 1. Imports
imps = '''import androidx.compose.foundation.horizontalScroll
...
new_map_header = '''        // Top Badges mapping the exact states we're in
        Row(
            ...
            IconButton(
                ...
                modifier = Modifier.background(Color.White.copy(alpha = 0.8f), androidx.compose.foundation.shape.CircleShape)
            ) {
